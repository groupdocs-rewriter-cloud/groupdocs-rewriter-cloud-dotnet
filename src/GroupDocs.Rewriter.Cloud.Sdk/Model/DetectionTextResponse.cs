...
namespace GroupDocs.Rewriter.Cloud.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DetectionTextResponse")]
    public partial class DetectionTextResponse : IEquatable<DetectionTextResponse>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DetectionTextResponse" /> class.
        /// </summary>
        ...
        public DetectionTextResponse(HttpStatusCode? statusCode = default(HttpStatusCode?), string message = default(string), float probability = default(float), bool isParaphrased = default(bool))
        {
        ...
        {
            return this.Equals(input as DetectionTextResponse);
        }

        /// <summary>
        /// Returns true if DetectionTextResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DetectionTextResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DetectionTextResponse input)
        {
            if (input == null)
            {
                return false;
