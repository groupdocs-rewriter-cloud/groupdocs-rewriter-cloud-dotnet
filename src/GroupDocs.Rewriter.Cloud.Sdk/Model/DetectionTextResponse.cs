...
namespace GroupDocs.Rewriter.Cloud.Sdk.Model
{
    ...
    public partial class DetectionTextResponse : IEquatable<DetectionTextResponse>, IValidatableObject
    {
        ...
        public DetectionTextResponse(StatusCodeEnum? statusCode = default(StatusCodeEnum?), string message = default(string), float probability = default(float), bool isParaphrased = default(bool))
        {
