...
namespace GroupDocs.Rewriter.Cloud.Sdk.Model
{
    ...
    public partial class DetectionFileRequest : IEquatable<DetectionFileRequest>, IValidatableObject
    {
        ...
        public DetectionSupportedFormats? Format { get; set; }
        /// <summary>
        ...
        public DetectionFileRequest(string language = default(string), string url = default(string), string origin = default(string), string originalName = default(string), FileSavingMode? savingMode = default(FileSavingMode?), int minLength = default(int), DetectionSupportedFormats? format = default(DetectionSupportedFormats?))
        {
