...
namespace GroupDocs.Rewriter.Cloud.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ParaphraseTrialFileRequest")]
    public partial class ParaphraseTrialFileRequest : IEquatable<ParaphraseTrialFileRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ParaphraseTrialFileRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ParaphraseTrialFileRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ParaphraseTrialFileRequest" /> class.
        /// </summary>
        ...
        public ParaphraseTrialFileRequest(string language = default(string), byte[] file = default(byte[]), string url = default(string), string origin = default(string), string originalName = default(string), FileSavingMode? savingMode = default(FileSavingMode?), DegreeEnum? diversityDegree = default(DegreeEnum?), TrialSupportedFormats? format = default(TrialSupportedFormats?))
        {
            // to ensure "language" is required (not null)
            if (language == null)
            {
                throw new ArgumentNullException("language is a required property for ParaphraseTrialFileRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as ParaphraseTrialFileRequest);
        }

        /// <summary>
        /// Returns true if ParaphraseTrialFileRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ParaphraseTrialFileRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ParaphraseTrialFileRequest input)
        {
            if (input == null)
            {
                return false;
