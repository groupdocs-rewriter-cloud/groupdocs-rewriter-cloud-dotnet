...
namespace GroupDocs.Rewriter.Cloud.Sdk.Model
{
    ...
    public partial class ParaphraseFileRequest : IEquatable<ParaphraseFileRequest>, IValidatableObject
    {
        ...
        public ParaphraseFileRequest(string language = default(string), SupportedFormats format = default(SupportedFormats), byte[] file = default(byte[]), string url = default(string), string origin = default(string), string originalName = default(string), SavingModeEnum? savingMode = default(SavingModeEnum?), SupportedConversionsFormats outputFormat = default(SupportedConversionsFormats), DiversityEnum? diversityDegree = default(DiversityEnum?))
        {
