...
namespace GroupDocs.Rewriter.Cloud.Sdk.Model
{
    ...
    public partial class ParaphraseFileRequest : IEquatable<ParaphraseFileRequest>, IValidatableObject
    {
        ...
        public ParaphraseSupportedFormats? Format { get; set; }
        /// <summary>
        ...
        public ParaphraseFileRequest(string language = default(string), string url = default(string), string origin = default(string), string originalName = default(string), FileSavingMode? savingMode = default(FileSavingMode?), SupportedConversionsFormats outputFormat = default(SupportedConversionsFormats), DegreeEnum? diversityDegree = default(DegreeEnum?), ParaphraseSupportedFormats? format = default(ParaphraseSupportedFormats?))
        {
