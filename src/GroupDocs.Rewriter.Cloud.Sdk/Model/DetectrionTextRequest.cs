...
{
    /// <summary>
    /// DetectrionTextRequest
    /// </summary>
    [DataContract(Name = "DetectrionTextRequest")]
    public partial class DetectrionTextRequest : IEquatable<DetectrionTextRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DetectrionTextRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DetectrionTextRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DetectrionTextRequest" /> class.
        /// </summary>
        ...
        public DetectrionTextRequest(string language = default(string), string text = default(string), List<string> texts = default(List<string>), string origin = default(string))
        {
            // to ensure "language" is required (not null)
            if (language == null)
            {
                throw new ArgumentNullException("language is a required property for DetectrionTextRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DetectrionTextRequest {\n");
        ...
        {
            return this.Equals(input as DetectrionTextRequest);
        }

        /// <summary>
        /// Returns true if DetectrionTextRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DetectrionTextRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DetectrionTextRequest input)
        {
            if (input == null)
            {
                return false;
