...
namespace GroupDocs.Rewriter.Cloud.Sdk.Model
{
    ...
    public partial class DetectionFileResponse : IEquatable<DetectionFileResponse>, IValidatableObject
    {
        ...
        public DetectionFileResponse(StatusCodeEnum? statusCode = default(StatusCodeEnum?), string message = default(string), float probability = default(float), bool isParaphrased = default(bool), List<float> perParagraphProbability = default(List<float>))
        {
