...
namespace GroupDocs.Rewriter.Cloud.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SimplifyTrialFileRequest")]
    public partial class SimplifyTrialFileRequest : IEquatable<SimplifyTrialFileRequest>, IValidatableObject
    {
        ...
        /// Set the file format.
        /// </summary>
        /// <value>Set the file format.</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SimplifyTrialFileRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SimplifyTrialFileRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SimplifyTrialFileRequest" /> class.
        /// </summary>
        ...
        /// <param name="format">Set the file format..</param>
        public SimplifyTrialFileRequest(string language = default(string), byte[] file = default(byte[]), string url = default(string), string origin = default(string), string originalName = default(string), FileSavingMode? savingMode = default(FileSavingMode?), FormatEnum? format = default(FormatEnum?))
        {
            // to ensure "language" is required (not null)
            if (language == null)
            {
                throw new ArgumentNullException("language is a required property for SimplifyTrialFileRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as SimplifyTrialFileRequest);
        }

        /// <summary>
        /// Returns true if SimplifyTrialFileRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SimplifyTrialFileRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SimplifyTrialFileRequest input)
        {
            if (input == null)
            {
                return false;
