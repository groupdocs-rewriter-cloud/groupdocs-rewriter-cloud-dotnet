...
namespace GroupDocs.Rewriter.Cloud.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DetectionTrialFileRequest")]
    public partial class DetectionTrialFileRequest : IEquatable<DetectionTrialFileRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DetectionTrialFileRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DetectionTrialFileRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DetectionTrialFileRequest" /> class.
        /// </summary>
        ...
        /// <param name="minLength">Minimum length of the source text.</param>
        /// <param name="format">format.</param>
        public DetectionTrialFileRequest(string language = default(string), string url = default(string), string origin = default(string), string originalName = default(string), FileSavingMode? savingMode = default(FileSavingMode?), int minLength = default(int), TrialSupportedFormats? format = default(TrialSupportedFormats?))
        {
            // to ensure "language" is required (not null)
            if (language == null)
            {
                throw new ArgumentNullException("language is a required property for DetectionTrialFileRequest and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Minimum length of the source text</value>
        ...
        {
            return this.Equals(input as DetectionTrialFileRequest);
        }

        /// <summary>
        /// Returns true if DetectionTrialFileRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DetectionTrialFileRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DetectionTrialFileRequest input)
        {
            if (input == null)
            {
                return false;
