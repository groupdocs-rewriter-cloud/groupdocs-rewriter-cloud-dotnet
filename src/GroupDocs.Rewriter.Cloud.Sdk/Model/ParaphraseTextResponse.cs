...
namespace GroupDocs.Rewriter.Cloud.Sdk.Model
{
    ...
    public partial class ParaphraseTextResponse : IEquatable<ParaphraseTextResponse>, IValidatableObject
    {
        ...
        public ParaphraseTextResponse(StatusCodeEnum? statusCode = default(StatusCodeEnum?), string message = default(string), string paraphraseReult = default(string), List<string> paraphraseResults = default(List<string>), List<string> sourceList = default(List<string>), List<string> targetList = default(List<string>))
        {
