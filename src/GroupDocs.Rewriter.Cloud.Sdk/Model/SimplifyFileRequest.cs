...
namespace GroupDocs.Rewriter.Cloud.Sdk.Model
{
    ...
    /// SimplifyFileRequest
    /// </summary>
    [DataContract(Name = "SimplifyFileRequest")]
    public partial class SimplifyFileRequest : IEquatable<SimplifyFileRequest>, IValidatableObject
    {
        ...
        public SimplifySupportedFromats? Format { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="SimplifyFileRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SimplifyFileRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SimplifyFileRequest" /> class.
        /// </summary>
        ...
        public SimplifyFileRequest(string language = default(string), string url = default(string), string origin = default(string), string originalName = default(string), FileSavingMode? savingMode = default(FileSavingMode?), SupportedConversionsFormats outputFormat = default(SupportedConversionsFormats), SimplifySupportedFromats? format = default(SimplifySupportedFromats?))
        {
            // to ensure "language" is required (not null)
            if (language == null)
            {
                throw new ArgumentNullException("language is a required property for SimplifyFileRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as SimplifyFileRequest);
        }

        /// <summary>
        /// Returns true if SimplifyFileRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SimplifyFileRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SimplifyFileRequest input)
        {
            if (input == null)
            {
                return false;
