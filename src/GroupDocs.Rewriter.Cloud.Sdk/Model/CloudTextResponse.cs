...
namespace GroupDocs.Rewriter.Cloud.Sdk.Model
{
    ...
    public partial class CloudTextResponse : IEquatable<CloudTextResponse>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Status code of request</value>
        ...
        /// </summary>
        /// <param name="status">Status code of request.</param>
        /// <param name="message">If file was paraphrased correctly or text of error.</param>
        /// <param name="paraphrase">Paraphrased texts.</param>
        /// <param name="paraphrases">Paraphrased texts.</param>
        /// <param name="sourceList">Source text split into sentences.</param>
        /// <param name="targetList">Rewrited text split into sentences.</param>
        public CloudTextResponse(StatusEnum? status = default(StatusEnum?), string message = default(string), string paraphrase = default(string), List<string> paraphrases = default(List<string>), List<string> sourceList = default(List<string>), List<string> targetList = default(List<string>))
        {
            this.Status = status;
        ...
        /// <summary>
        /// If file was paraphrased correctly or text of error
        /// </summary>
        /// <value>If file was paraphrased correctly or text of error</value>
        ...
        /// Paraphrased texts
        /// </summary>
        /// <value>Paraphrased texts</value>
        [DataMember(Name = "paraphrase", EmitDefaultValue = true)]
        ...
        /// </summary>
        /// <value>Paraphrased texts</value>
        [DataMember(Name = "paraphrases", EmitDefaultValue = true)]
        public List<string> Paraphrases { get; set; }

        /// <summary>
        /// Source text split into sentences
        /// </summary>
        /// <value>Source text split into sentences</value>
        ...
        /// </summary>
        /// <value>Rewrited text split into sentences</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Paraphrase: ").Append(Paraphrase).Append("\n");
            sb.Append("  Paraphrases: ").Append(Paraphrases).Append("\n");
        ...
        public bool Equals(CloudTextResponse input)
        {
            ...
            return 
                ...
                (
                    this.Paraphrase == input.Paraphrase ||
                    (this.Paraphrase != null &&
                    this.Paraphrase.Equals(input.Paraphrase))
                ) && 
                (
                    this.Paraphrases == input.Paraphrases ||
                    this.Paraphrases != null &&
                    input.Paraphrases != null &&
                    this.Paraphrases.SequenceEqual(input.Paraphrases)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.Paraphrase.GetHashCode();
                }
                if (this.Paraphrases != null)
                {
                    hashCode = (hashCode * 59) + this.Paraphrases.GetHashCode();
                }
