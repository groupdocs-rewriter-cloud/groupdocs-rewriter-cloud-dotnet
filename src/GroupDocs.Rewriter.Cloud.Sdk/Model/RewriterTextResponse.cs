...
{
    /// <summary>
    /// RewriterTextResponse
    /// </summary>
    [DataContract(Name = "RewriterTextResponse")]
    public partial class RewriterTextResponse : IEquatable<RewriterTextResponse>, IValidatableObject
    {
        /// <summary>
        /// Http status code
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RewriterTextResponse" /> class.
        /// </summary>
        ...
        public RewriterTextResponse(StatusCodeEnum? statusCode = default(StatusCodeEnum?), string message = default(string), string paraphraseReult = default(string), List<string> paraphraseResults = default(List<string>), List<string> sourceList = default(List<string>), List<string> targetList = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RewriterTextResponse {\n");
        ...
        {
            return this.Equals(input as RewriterTextResponse);
        }

        /// <summary>
        /// Returns true if RewriterTextResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of RewriterTextResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RewriterTextResponse input)
        {
            if (input == null)
            {
                return false;
