...
namespace GroupDocs.Rewriter.Cloud.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DetectionTextRequest")]
    public partial class DetectionTextRequest : IEquatable<DetectionTextRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DetectionTextRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DetectionTextRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DetectionTextRequest" /> class.
        /// </summary>
        ...
        public DetectionTextRequest(string language = default(string), string text = default(string), List<string> texts = default(List<string>), string origin = default(string))
        {
            // to ensure "language" is required (not null)
            if (language == null)
            {
                throw new ArgumentNullException("language is a required property for DetectionTextRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as DetectionTextRequest);
        }

        /// <summary>
        /// Returns true if DetectionTextRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DetectionTextRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DetectionTextRequest input)
        {
            if (input == null)
            {
                return false;
