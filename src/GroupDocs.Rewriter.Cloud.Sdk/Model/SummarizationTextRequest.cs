...
namespace GroupDocs.Rewriter.Cloud.Sdk.Model
{
    ...
    public partial class SummarizationTextRequest : IEquatable<SummarizationTextRequest>, IValidatableObject
    {
        ...
        public SummarizationTextRequest(string language = default(string), string text = default(string), List<string> texts = default(List<string>), string origin = default(string), DegreeEnum? summarizationDegree = default(DegreeEnum?))
        {
