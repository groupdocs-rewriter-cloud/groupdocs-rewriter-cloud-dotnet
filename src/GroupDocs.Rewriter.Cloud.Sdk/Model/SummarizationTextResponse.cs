...
namespace GroupDocs.Rewriter.Cloud.Sdk.Model
{
    ...
    public partial class SummarizationTextResponse : IEquatable<SummarizationTextResponse>, IValidatableObject
    {
        ...
        public SummarizationTextResponse(StatusCodeEnum? statusCode = default(StatusCodeEnum?), string message = default(string), string summarizatinoResult = default(string), List<string> summarizationResults = default(List<string>))
        {
