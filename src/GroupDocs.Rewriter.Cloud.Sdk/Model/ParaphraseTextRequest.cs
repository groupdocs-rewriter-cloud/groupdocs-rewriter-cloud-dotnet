...
namespace GroupDocs.Rewriter.Cloud.Sdk.Model
{
    ...
    public partial class ParaphraseTextRequest : IEquatable<ParaphraseTextRequest>, IValidatableObject
    {
        ...
        public DiversityEnum? DiversityDegree { get; set; }
        /// <summary>
        ...
        public ParaphraseTextRequest(string language = default(string), string text = default(string), List<string> texts = default(List<string>), string origin = default(string), SuggestionsEnum? suggestions = default(SuggestionsEnum?), DiversityEnum? diversityDegree = default(DiversityEnum?), bool tokenize = default(bool))
        {
