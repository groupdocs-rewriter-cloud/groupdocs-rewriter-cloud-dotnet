...
namespace GroupDocs.Rewriter.Cloud.Sdk.Model
{
    ...
    /// BaseTextRequest
    /// </summary>
    [DataContract(Name = "BaseTextRequest")]
    public partial class BaseTextRequest : IEquatable<BaseTextRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BaseTextRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BaseTextRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BaseTextRequest" /> class.
        /// </summary>
        ...
        public BaseTextRequest(string language = default(string), string text = default(string), List<string> texts = default(List<string>), string origin = default(string))
        {
            // to ensure "language" is required (not null)
            if (language == null)
            {
                throw new ArgumentNullException("language is a required property for BaseTextRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BaseTextRequest {\n");
        ...
        {
            return this.Equals(input as BaseTextRequest);
        }

        /// <summary>
        /// Returns true if BaseTextRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of BaseTextRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BaseTextRequest input)
        {
            if (input == null)
            {
                return false;
