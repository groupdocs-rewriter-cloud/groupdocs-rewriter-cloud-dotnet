...
namespace GroupDocs.Rewriter.Cloud.Sdk.Api
{
    ...
    public interface IDetectApiSync : IApiAccessor
    {
        ...
        /// <param name="detectDocumentPostRequest"> (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>StatusResponse</returns>
        StatusResponse DetectDocumentPost(DetectDocumentPostRequest detectDocumentPostRequest = default(DetectDocumentPostRequest), int operationIndex = 0);
        ...
        ApiResponse<StatusResponse> DetectDocumentPostWithHttpInfo(DetectDocumentPostRequest detectDocumentPostRequest = default(DetectDocumentPostRequest), int operationIndex = 0);
        /// <summary>
    ...
    public interface IDetectApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<StatusResponse> DetectDocumentPostAsync(DetectDocumentPostRequest detectDocumentPostRequest = default(DetectDocumentPostRequest), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<StatusResponse>> DetectDocumentPostWithHttpInfoAsync(DetectDocumentPostRequest detectDocumentPostRequest = default(DetectDocumentPostRequest), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Return document detection status.  Also return probability of paraphrasing for the whole document and per paragraph
        /// </summary>
        /// <remarks>
    ...
    public partial class DetectApi : IDetectApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>StatusResponse</returns>
        public StatusResponse DetectDocumentPost(DetectDocumentPostRequest detectDocumentPostRequest = default(DetectDocumentPostRequest), int operationIndex = 0)
        {
            GroupDocs.Rewriter.Cloud.Sdk.Client.ApiResponse<StatusResponse> localVarResponse = DetectDocumentPostWithHttpInfo(detectDocumentPostRequest);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of StatusResponse</returns>
        public GroupDocs.Rewriter.Cloud.Sdk.Client.ApiResponse<StatusResponse> DetectDocumentPostWithHttpInfo(DetectDocumentPostRequest detectDocumentPostRequest = default(DetectDocumentPostRequest), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Data = detectDocumentPostRequest;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of StatusResponse</returns>
        public async System.Threading.Tasks.Task<StatusResponse> DetectDocumentPostAsync(DetectDocumentPostRequest detectDocumentPostRequest = default(DetectDocumentPostRequest), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            GroupDocs.Rewriter.Cloud.Sdk.Client.ApiResponse<StatusResponse> localVarResponse = await DetectDocumentPostWithHttpInfoAsync(detectDocumentPostRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (StatusResponse)</returns>
        public async System.Threading.Tasks.Task<GroupDocs.Rewriter.Cloud.Sdk.Client.ApiResponse<StatusResponse>> DetectDocumentPostWithHttpInfoAsync(DetectDocumentPostRequest detectDocumentPostRequest = default(DetectDocumentPostRequest), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
