...
namespace GroupDocs.Rewriter.Cloud.Sdk.Api
{
    ...
    public partial class SwaggerApi : ISwaggerApi
    {
        ...
        /// <returns></returns>
        public SwaggerApi(GroupDocs.Rewriter.Cloud.Sdk.Client.Configuration configuration)
        {
        ...
        public SwaggerApi(GroupDocs.Rewriter.Cloud.Sdk.Client.ISynchronousClient client, GroupDocs.Rewriter.Cloud.Sdk.Client.IAsynchronousClient asyncClient, GroupDocs.Rewriter.Cloud.Sdk.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public GroupDocs.Rewriter.Cloud.Sdk.Client.ApiResponse<Object> SwaggerSpecGetWithHttpInfo(bool? isYaml = default(bool?), bool? serialaizeAsV2 = default(bool?), int operationIndex = 0)
        {
            ...
            if (isYaml != null)
            {
                localVarRequestOptions.QueryParameters.Add(GroupDocs.Rewriter.Cloud.Sdk.Client.ClientUtils.ParameterToMultiMap("", "IsYaml", isYaml));
            }
            if (serialaizeAsV2 != null)
            {
                localVarRequestOptions.QueryParameters.Add(GroupDocs.Rewriter.Cloud.Sdk.Client.ClientUtils.ParameterToMultiMap("", "SerialaizeAsV2", serialaizeAsV2));
            }
