...
namespace GroupDocs.Rewriter.Cloud.Sdk.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("GroupDocs.Rewriter API for C#: 23.11.0");
            BasePath = "https://api.groupdocs.cloud/v2.0/rewriter";
        ...
        public Configuration(
            ...
            string basePath = "https://api.groupdocs.cloud/v2.0/rewriter") : this()
        {
        ...
        {
            string report = "C# SDK (GroupDocs.Rewriter.Cloud.Sdk) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 23.11.0\n";
